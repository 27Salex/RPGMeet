...
CREATE TABLE Tema (
    ...
    NombreTema NVARCHAR(100) UNIQUE NOT NULL
);

CREATE TABLE Juego (
    IdJuego INT IDENTITY(1,1) PRIMARY KEY,
    NombreJuego NVARCHAR(100) UNIQUE NOT NULL,
...
CREATE TABLE Grupo (
    ...
    TituloParitda NVARCHAR (50) NOT NULL,
...
VALUES ('Dungeon and Dragons 5e', 'Reglas de la 5 edición de Dungeons and Dragons.', 2, 6);

INSERT INTO Juego (NombreJuego, Reglas, MinJugadores, MaxJugadores) 
VALUES ('Dungeon and Dragons 3.5e', 'Reglas de la 3.5 edición de Dungeons and Dragons.', 2, 8);

INSERT INTO Juego (NombreJuego, Reglas, MinJugadores, MaxJugadores) 
VALUES ('Dungeon and Dragons 4e', 'Reglas de la 4 edición de Dungeons and Dragons.', 3, 7);
