        ...
        <div class="col-md-12 mt-3 mb-3">
            ...
            <section class="row">
                ...
                <div class="col-md-9">
                    ...
                    <asp:Image ID="Image2" runat="server" CssClass="rounded-circle"/>
                    <asp:Image ID="Image3" runat="server" CssClass="rounded-circle"/>
                    <asp:Image ID="Image4" runat="server" CssClass="rounded-circle"/>
                    <asp:Image ID="Image5" runat="server" CssClass="rounded-circle"/>
                    <asp:Image ID="Image6" runat="server" CssClass="rounded-circle"/>
                    <asp:Image ID="Image7" runat="server" CssClass="rounded-circle"/>
                </div>
            </section>
        </div>
</div>
