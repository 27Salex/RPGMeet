...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div >
        ...
        <div id="EditUser" class="container h5 p-5 bg-glass shadow rounded animate__animated animate__fadeInLeft" runat="server" visible="false">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <Label class="form-label">Nombre de Usuario:</Label>
                    <div class="input-group">
                        <div class="input-group-text bg-glass"><i class="bi bi-person-fill"></i></div>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="input-group">
                        <div class="input-group-text bg-glass"><i class="bi bi-flag-fill"></i></div>
        ...
        <div id="ShowUser" class="container h5 bg-glass p-5 shadow rounded animate__animated animate__fadeInRight" runat="server">
            <div class="row">
                <!--Campos User -->
                <div class="col-md-6 col-sm-12">
                    <Label class="form-label">Nombre de Usuario:</Label>
